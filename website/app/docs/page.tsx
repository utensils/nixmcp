...
export default function DocsPage() {
    ...
    <div className="py-12 bg-white">
      <div className="container-custom">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <AnchorHeading level={2} className="text-2xl font-bold mt-8 mb-6 text-nix-primary border-b border-nix-light pb-2">Usage Examples</AnchorHeading>
          ...
          <div className="bg-white rounded-lg shadow-sm border-l-4 border-nix-primary p-5 mb-6">
            ...
            <p className="text-gray-700 mb-4">These examples demonstrate basic chat interactions with AI assistants using MCP-NixOS tools. Each example illustrates the flow of tool calls that AI agents can make to retrieve information and provide comprehensive answers. AI assistants have direct access to these tools, allowing them to gather real-time Nix ecosystem data without requiring users to know the underlying commands or API structure.</p>
  ...
  "metadata": {
    ...
    "query_time_ms": 42
          ...
          <div className="bg-white rounded-lg shadow-sm border-l-4 border-nix-primary p-5 mb-6">
            ...
            <p className="text-gray-700 mb-4">These examples demonstrate simple use cases for MCP-NixOS tools and the type of information they provide.</p>
            
            <div className="space-y-6">
              <div className="border border-gray-200 rounded-lg p-4">
                <h4 className="font-semibold text-nix-primary mb-2">User Prompt</h4>
                <p className="text-gray-700 mb-3">&quot;What PostgreSQL versions are available in NixOS, and what are the configuration options?&quot;</p>
                
                <div className="mb-3">
                  <h5 className="text-md font-semibold mb-2 text-nix-dark">Tool Call 1: Search for PostgreSQL Packages</h5>
                  <CodeBlock
                    code={`{  
  "type": "call",
  "tool": "nixos_search",
  "params": {
    ...
    "limit": 10
                ...
                <div className="mb-3">
                  <h5 className="text-md font-semibold mb-2 text-nix-dark">Available PostgreSQL Versions:</h5>
...
- postgresql14JitPackages.lantern (0.5.0)
  PostgreSQL vector database extension for building AI applications`}
                ...
                <div className="mb-3">
                  <h5 className="text-md font-semibold mb-2 text-nix-dark">Tool Call 2: Get PostgreSQL Service Options</h5>
                  <CodeBlock
                    code={`{  
  "type": "call",
  "tool": "nixos_info",
  "params": {
    ...
    "type": "option"
                ...
                <div className="mb-3">
                  <h5 className="text-md font-semibold mb-2 text-nix-dark">PostgreSQL Configuration Options:</h5>
                  <div className="bg-gray-50 p-3 rounded-md border border-gray-200">
                    <CodeBlock
...
- \`services.postgresql.enableTCPIP\` (boolean)
  Whether PostgreSQL should listen on all network interfaces.`}
                ...
                <div className="bg-blue-50 p-3 rounded-md border border-blue-200">
                  <h5 className="text-md font-semibold mb-1 text-blue-700">AI Assistant Response:</h5>
                  <p className="text-gray-700">NixOS provides multiple PostgreSQL versions (13, 14, 15, 16, and 17) that can be selected using the <code className="font-mono text-xs">services.postgresql.package</code> option. The default version is currently 17.4.</p>
                  ...
                  <ul className="list-disc list-inside mt-1 text-gray-700 space-y-1">
                    <li>Authentication methods via <code className="font-mono text-xs">services.postgresql.authentication</code></li>
                    <li>Network listening control with <code className="font-mono text-xs">services.postgresql.enableTCPIP</code></li>
                    <li>Performance tuning with <code className="font-mono text-xs">services.postgresql.enableJIT</code></li>
                    <li>Data storage location via <code className="font-mono text-xs">services.postgresql.dataDir</code></li>
                  </ul>
                  <p className="text-gray-700 mt-2">This information helps system administrators choose the appropriate PostgreSQL version and configure it according to their specific requirements.</p>
                </div>
              </div>

              <div className="border border-gray-200 rounded-lg p-4 mt-6">
                <h4 className="font-semibold text-nix-primary mb-2">Example 2: Checking Package Availability</h4>
                <h4 className="font-semibold text-nix-primary mb-2">User Prompt</h4>
                <p className="text-gray-700 mb-3">&quot;Is the tldr package available in NixOS, and what variants exist?&quot;</p>
                
                <div className="mb-3">
                  <h5 className="text-md font-semibold mb-2 text-nix-dark">Tool Call 1: Search for tldr Package</h5>
                  <CodeBlock
                    code={`{  
  "type": "call",
  "tool": "nixos_search",
  "params": {
    ...
    "limit": 10
                ...
                <div className="mb-3">
                  <h5 className="text-md font-semibold mb-2 text-nix-dark">Search Results:</h5>
                  <div className="bg-gray-50 p-3 rounded-md border border-gray-200">
                    <CodeBlock
...
- rPackages.tldr (0.4.0)`}
                ...
                <div className="mb-3">
                  <h5 className="text-md font-semibold mb-2 text-nix-dark">Tool Call 2: Get Detailed Package Information</h5>
                  <CodeBlock
                    code={`{  
  "type": "call",
  "tool": "nixos_info",
  "params": {
    ...
    "type": "package"
                ...
                <div className="mb-3">
                  <h5 className="text-md font-semibold mb-2 text-nix-dark">Package Details:</h5>
                  <div className="bg-gray-50 p-3 rounded-md border border-gray-200">
                    <CodeBlock
                      code={`# tldr
...
**Provided Programs:** tldr`}
                ...
                <div className="bg-blue-50 p-3 rounded-md border border-blue-200">
                  <h5 className="text-md font-semibold mb-1 text-blue-700">AI Assistant Response:</h5>
                  <p className="text-gray-700">NixOS provides several implementations of the tldr client:</p>
                  <ul className="list-disc list-inside mt-1 text-gray-700 space-y-1">
                    <li>The main Python-based <code className="font-mono text-xs">tldr</code> package</li>
                    <li>Rust implementations: <code className="font-mono text-xs">tlrc</code> (official) and <code className="font-mono text-xs">tealdeer</code> (optimized for speed)</li>
                    <li>Language-specific implementations for Haskell, Emacs Lisp, and R</li>
                  </ul>
                  <p className="text-gray-700 mt-2">The main package is available across multiple platforms and provides a simple command-line interface for accessing community-maintained simplified documentation. This is particularly useful for quickly finding common usage examples without having to read through comprehensive man pages.</p>
                </div>
              </div>
            </div>
          </div>
