          ...
          <div className="bg-white rounded-lg shadow-sm border-l-4 border-nix-primary p-5 mb-6">
            ...
            <div className="space-y-6">
              <div className="border border-gray-200 rounded-lg p-4">
                <h4 className="font-semibold text-nix-primary mb-2">Example 1: PostgreSQL Versions and Configuration</h4>
...
- \`services.postgresql.enableTCPIP\` (boolean)
  Whether PostgreSQL should listen on all network interfaces.`}
                ...
                <div className="bg-blue-50 p-3 rounded-md border border-blue-200">
                  <h5 className="text-md font-semibold mb-1 text-blue-700">Insight:</h5>
