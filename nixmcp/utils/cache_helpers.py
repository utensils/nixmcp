...
def get_default_cache_dir(app_name: str = "nixmcp") -> str:
    """
...
def ensure_cache_dir(cache_dir: Optional[str] = None, app_name: str = "nixmcp") -> str:
    """
    ...
    if cache_dir:
        ...
        env_cache_dir = os.environ.get("NIXMCP_CACHE_DIR")
        if env_cache_dir:
            logger.info(f"Using cache directory from NIXMCP_CACHE_DIR: {env_cache_dir}")
