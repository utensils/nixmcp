"""
MCP completion package for MCP-NixOS.

This package provides MCP completion implementations for various resource types
and tools in MCP-NixOS, enabling IDE-like code suggestions and tab completion.
"""
...
async def complete_prompt_argument(
    ...
    logger.debug("Currently no prompt completion support in MCP-NixOS")
