...
def get_tool_tips(tool_name: str) -> Dict[str, str]:
    ...
    tips = {
        ...
        "home_manager_info": {
            "option_paths": "Use the full path like 'programs.git.userName'"
        },
        "home_manager_stats": {
            "usage": "Use this for an overview of available options by category"
        },
        "home_manager_list_options": {
            "exploration": "Use this for exploring available option categories"
        },
        "home_manager_options_by_prefix": {
            "common_prefixes": "Common prefixes include 'programs', 'services', 'xdg'"
        },
        "darwin_search": {
        ...
        "darwin_info": {
            "verify_first": "First use darwin_search to find the exact option path"
        },
        "darwin_stats": {
            "usage": "Use this for an overview of available options by category"
        },
        "darwin_list_options": {
            "exploration": "Use this to explore top-level option categories"
        },
        "darwin_options_by_prefix": {
            "common_prefixes": "Common prefixes include 'services', 'system.defaults', 'system.keyboard'"
        },
        "discover_tools": {
            "usage": "Use this when you need to know what tools are available"
        },
        "get_tool_usage": {
            "tool_exploration": "Use this to understand how to use a specific tool"
        }
    }
