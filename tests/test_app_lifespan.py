...
from nixmcp.server import app_lifespan, NixOSContext, HomeManagerContext
...
TestAppLifespan.test_app_lifespan_exception_handling = async_to_sync(TestAppLifespan.test_app_lifespan_exception_handling)
TestAppLifespan.test_app_lifespan_cleanup_on_exception = async_to_sync(TestAppLifespan.test_app_lifespan_cleanup_on_exception)
