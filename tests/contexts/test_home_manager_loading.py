...
class TestHomeManagerContextLoading(unittest.TestCase):
    ...
    def test_context_loaded_success(self, MockClient):
        ...
        self.mock_client.get_option.return_value = {"name": "test.option", "description": "Test option", "found": True}

        self.mock_client.get_stats.return_value = {"total_options": 100, "found": True}
...
class TestHomeManagerContextLoadingThreads(unittest.TestCase):
    ...
    def test_background_loading(self, MockClient):
        ...
        # Create context but don't use the reference in this test
        HomeManagerContext()
